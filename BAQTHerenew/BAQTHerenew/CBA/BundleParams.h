...
inline BundleParams::BundleParams() {
    ...
    arg.param("sparse_linear_algebra_library", sparse_linear_algebra_library, "suite_sparse",
	...
	arg.param("num_iterations", num_iterations, 100, "Number of iterations.");
...
//BundleParams::BundleParams(int argc, char **argv) : BundleParams() {
